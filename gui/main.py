...
def main():
    ...
    translate_button.grid(row=0, column=0, padx=10, pady=10)  # 将按钮添加到窗口，并设置位置和间距

    translate_pdf_button = tk.Button(root, text="Translate PDF", command=translate_pdf)  # 创建一个按钮，用于翻译PDF
    translate_pdf_button.grid(row=0, column=2, padx=10, pady=10)  # 将按钮添加到窗口，并设置位置和间距

    # 创建文本框
    original_text = tk.Text(root, height=10, width=50)  # 创建一个文本框，用于输入原文
    original_text.grid(row=1, column=0, padx=10, pady=10)  # 将文本框添加到窗口，并设置位置和间距

    translated_text = tk.Text(root, height=10, width=50)  # 创建一个文本框，用于显示译文
    translated_text.grid(row=1, column=4, padx=10, pady=10)  # 将文本框添加到窗口，并设置位置和间距
    ...
    src_lang_combobox.grid(row=2, column=0, padx=10, pady=20)  # 将下拉框添加到窗口，并设置位置和间距
